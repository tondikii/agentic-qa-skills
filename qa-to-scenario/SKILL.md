...
5. Write `preparation.md` from `templates/preparation.md`: one PREP-ID item per setup need across test-data, credentials (env var names only), environment, and seed/reset, each with agent/human owner.
6. Write the empty `report.md` from `templates/report.md`.
